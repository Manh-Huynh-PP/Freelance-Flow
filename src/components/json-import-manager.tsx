...
export function JsonImportManager({ onImportComplete }: JsonImportManagerProps) {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      // Restore data using restoreAppData for full restore and ID remapping
      await dashboardContext.restoreAppData({
        tasks: data.tasks || [],
        quotes: data.quotes || [],
      ...
      toast({
        ...
        description: `Successfully restored ${data.tasks.length} tasks and other data from JSON backup.`,
      });
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {isImporting ? 'Restoring...' : 'Restore JSON Data'}
          </Button>
        ...
        <div className="text-sm text-muted-foreground">
          <p>
            <strong>JSON Restore Features:</strong>
          </p>
          <ul className="list-disc list-inside space-y-1 mt-2">
            <li>Restores database state from backup file</li>
            <li>Replaces existing data with backup content</li>
            <li>Regenerates IDs to prevent conflicts</li>
            <li>Restores all relationships and links</li>
          </ul>
        </div>
      </CardContent>
    </Card>
