      ...
      {showValidityNote !== false && (
        <div className="mt-6 sm:mt-8 text-center">
          <p className="text-xs sm:text-sm text-gray-500 italic px-4">
            {settings?.quoteValidityNote || T.quoteValidityNote || 'Giá trị báo giá tồn tại trong 30 ngày kể từ ngày cấp. Vui lòng liên hệ chúng tôi nếu bạn có bất kỳ câu hỏi nào.'}
          </p>
        </div>
      )}
    </div>
