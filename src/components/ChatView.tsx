...
// import { InteractiveElements } from '@/components/ai/InteractiveElements'; // Removed: Component deleted
                  ...
                  <div className={cn(
                    ...
                    <Card className={cn(
                      ...
                      <CardContent className={cn(
                        ...
                        {/* Interactive Elements - Removed as component was deleted */}
                        {/* {message.interactiveElements && message.interactiveElements.length > 0 && (
                          <div className="pt-3 border-t border-border/50">
                             // InteractiveElements removed 
                          </div>
                        )} */}
                      </CardContent>
                    </Card>
