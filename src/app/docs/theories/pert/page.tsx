...
import { Circle, GitBranch, TrendingUp, CheckCircle2, Network } from 'lucide-react';
...
export default function PertTheoryPage() {
    const { language } = useDocsLanguage();
    const t = (docsTranslations[language].theories as any).pert;
    ...
    return (
        <div className="space-y-10 max-w-5xl mx-auto py-6">
            ...
            <div className="relative w-full aspect-video rounded-xl overflow-hidden border shadow-lg">
                <Image
                    src="/landing/screenshots/pert-desktop.webp"
                    alt="PERT Diagram View"
                    fill
            ...
            <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {t.components.map((component: any, idx: number) => {
                        const Icon = iconMap[component.icon] || Circle;
                        return (
